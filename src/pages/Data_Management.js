...
import DM_Contents from '../components/DM_Contents';
    ...
    <>   
        ...
        <ThemeProvider theme={defaultTheme}>
            <Box sx={{ display: 'flex' }}>
                ...
                <Drawer variant="permanent" open={open}>
                    ...
                    {open ? (
                        ...
                        <ListItem sx={{ backgroundColor: '#0284c7',
                                    ...
                                    }} button divider onClick={dataManagementHandler}>
                            <ListItemIcon sx={{ color: 'white' }}>
                                <StorageIcon />
                            </ListItemIcon>
                            <ListItemText sx={{ color: 'white' }} primary="Data Management" />
                        </ListItem>
                        {!isAdmin && (
                ...
                >
                    <Toolbar />
                    <DM_Contents provinceIndex={provinceIndex} citiesIndex={citiesIndex} 
