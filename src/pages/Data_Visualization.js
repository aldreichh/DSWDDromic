...
import DV_Contents from '../components/DV_Contents';
    ...
    <>
        ...
        <ThemeProvider theme={defaultTheme}>
            <Box sx={{ display: 'flex' }}>
                ...
                <Drawer variant="permanent" open={open}>
                    ...
                    {open ? (
                        ...
                        <ListItem sx={{ backgroundColor: '#0284c7',
                                    ...
                                    }} button onClick={dataVisualizationHandler}>
                            <ListItemIcon sx={{ color: 'white' }}>
                                <BarChartIcon />
                            </ListItemIcon>
                            <ListItemText sx={{ color: 'white' }} primary="Data Visualization" />
                        </ListItem>
                        <Divider />
                ...
                >
                    <Toolbar />
                    <DV_Contents    provinceIndex={provinceIndex} citiesIndex={citiesIndex} showExportButton={showExportButton}
